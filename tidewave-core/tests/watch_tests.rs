...
async fn test_watch_concurrent_subscribers() {
    ...
    let (ws1_out_tx, mut ws1_out_rx, ws1_in_tx, ws1_in_rx) = create_fake_phoenix_socket();
    let (ws2_out_tx, mut ws2_out_rx, ws2_in_tx, ws2_in_rx) = create_fake_phoenix_socket();
